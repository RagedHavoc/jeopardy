...
function renderQuestions() {
  // Add code here
  //let questoionValues = [100, 200, 300, 400, 500];
  for (let questionValue of questionValues) {
    for (let inner = 0; inner < numCategories; inner++) {
      let questionValueHtml =
        "<div class='questions-column'><div class='question-cell'>" +
        questionValue +
        "</div></div>";

      $("#questions").append(questionValueHtml);
    }
  }
}
